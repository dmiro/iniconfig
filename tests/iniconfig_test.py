...
class MiIni(IniConfig):

    a = IniConfig.iniproperty(section='section', option='option1', default=False)
    b = IniConfig.iniproperty(section='section', option='option3', default=40)
    c = IniConfig.iniproperty(section='section', option='option2', default=0)
    d = IniConfig.iniproperty(section='section', option='option4', default=[])
    e = IniConfig.iniproperty(section='section', option='option5', default={'uno':1, 'dos':2})
    f = IniConfig.iniproperty(section='section', option='option6', default=False)
...
x.a = True
x.b = 11.5
x.d = ['hola', 'adios', 'chao', 'ja']
x.c = 40
x.e = {'uno':1, 'dos':2, 'tres':3}
x.f = True
x.e['cuatro'] = 4
del x.e['uno']
x.d.append('ok')
...
print 'e', x.e
print 'f', x.f
print 'a', x.a.__class__.__name__
print 'b', x.b.__class__.__name__
print 'c', x.c.__class__.__name__
print 'd', x.d.__class__.__name__
print 'e', x.e.__class__.__name__
print 'f', x.f.__class__.__name__
